...
st.set_page_config(page_title="LangChain-Vortrag", page_icon="🤖")

st.markdown(f"### Wilkommen in der KI-Werkstatt!")
st.markdown("Bitte wähle eine Funktion in der rechten Seitenleiste.")
st.info("We love data. And we are German programmer. So we respect your data.")
st.divider()
...
st.sidebar.write("[View the source code](https://github.com/HorstA/vortrag-langchain)")
